...
exports.retrieveOne = function (req, res) {
    ...
    Landscape.findOne({_id: id})
        .populate('createdBy', 'name email')
        .exec(function(err, landscape) {
        if (err) {
...
exports.create = function (req, res) {
    ...
    newLandscape.img.data = fs.readFileSync(data.imageUri);
    newLandscape.img.contentType = mime.lookup(data.imageUri);
...
exports.update = function (req, res) {
    ...
    Landscape.findOne(query, function (err, doc) {
        if (err) {
            ...
            doc.img.data = fs.readFileSync(doc.imageUri);
            doc.img.contentType = mime.lookup(doc.imageUri);
