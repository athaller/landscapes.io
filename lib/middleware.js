...
module.exports = {
    ...
    setUserCookie: function(req, res, next) {
        ...
        if(req.user) {
            console.log(' ---> setUserCookie > get Groups for user...');
            Group.find({ users: req.user._id }, function (err, groups) {
                if (err) {
                    ...
                    console.log(' ---> setUserCookie > req.user.groups: ' + JSON.stringify(userGroups));

                    console.log(' ---> setUserCookie > get Permissions for user...');
                    ...
                    console.log(' ---> setUserCookie > req.user.permissions = ' + JSON.stringify(req.user.permissions));
                }
            ...
            console.log(' ---> setUserCookie > req.user not found!');
            return next();
        }
    }
};